...
//        clock_gettime(CLOCK_REALTIME, &tmstart);
	...
	for (i=0; i<ND; i++) {
        ...
        #pragma acc kernels 
        {
        #pragma acc loop  collapse(7)  gang worker(32) private(k1,k2,k3,m,n,u,v,i,j,k,l,G,fk)/*tile(2,1,2)*/
        #endif
	for(k1=0;k1<N1;k1++)
        {
	       ...
	       for(k2=0;k2<N2;k2++)
		{
			...
			/*	#ifdef GPU
				...
				*/	
				...
				#ifdef GPUU 
				#pragma acc loop vector(32) private(k1,k2,k3,m,n,u,v,i,j,k,l,G,fk,nfreq,fk4)    
				#endif
					for (m=0; m<ND; m++) {
			        #ifdef GPUU
