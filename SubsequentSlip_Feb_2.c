...
#define		DELTA4(i,j,k,l) (((i==j) && (j==k) && (k==l))?1:0)
    ...
    #ifdef GPU 
    #pragma acc data create(fx[0:N1*N2*N3],fy[0:N1*N2*N3],fz[0:N1*N2*N3]) /*create(C[0:ND][0:ND][0:ND][0:ND])*/    
    //#pragma acc data /*copyin(eps[0:NS][0:ND][0:ND])  create(G[0:ND][0:ND])*/ /*copyin(data[0: 2*(NSV)*(N1)*(N2)*(N3)])*/ 
 ...
 //*****SAFE on Multicore But fails on GPU!!!   
        ...
        #pragma acc kernels 
        {
	#pragma acc loop private(u,v,i,j,k,nfreq,index)      
	#endif 
...
//        clock_gettime(CLOCK_REALTIME, &tmstart);
	...
	for (i=0; i<ND; i++) {
        ...
        #pragma acc kernels 
        {
        #pragma acc loop  collapse(3)  /*gang vector(32)*/   /*gang worker(32)*/  private(k1,k2,k3,m,n,u,v,i,j,k,l,fk,nfreq,fk4,G)/*tile(2,1,2)*/ 
        #endif
	for(k1=0;k1<N1;k1++)  
        {
	       ...
	       for(k2=0;k2<N2;k2++)
		{
			...
			/*	#ifdef GPU
				...
				*/	
				...
				#ifdef UGPU
				#pragma acc loop vector(32) /*private(k1,k2,k3,m,n,u,v,i,j,k,l,G,fk,nfreq,fk4)*/  collapse(4)    
				#endif
					for (m=0; m<ND; m++) {
			        #ifdef GPUU
				...
				#pragma acc loop private(A,G)  
								...
								for (v=0; v<ND; v++) {
					                          ...
					                          A[k1][k2][k3][m][n][u][v] = 0.0;
				#ifdef UGPU 
				#pragma acc loop /*private(k1,k2,k3,m,n,u,v,i,j,k,l,G,fk,nfreq,fk4)*/ collapse(3)   
				#endif					
				...
				#ifdef UGPU
				#pragma acc loop private(k1,k2,k3,m,n,u,v,i,j,k,l,G,fk,nfreq,fk4)    
				#endif	
